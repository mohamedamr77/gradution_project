class AppText {
  ...
  static const String textTest1 =
      '"يرجى مراجعة الحالة الصحية للطفل قبل موعد التطعيم”';
...
(جرعة ثالثة إن وُجدت): عند عمر 14 أسبوعًا.
  ...
  static const String welcomeMessage =
      "أهلاً بك كل ما تحتاجينه لصحة طفلك \n في مكان واحد";
...
// Add more constants below...
  ...
  static const String sideEffectsTuberculosisVaccine =
      "الاعراض الجانبيه لتطعيم الدرن";
  ...
  static const String preVaccineTips =
      '''1. تأكد من استشارة الطبيب: إذا كان الطفل يعاني من الحمى أو أي مرض، استشر الطبيب لتحديد ما إذا كان من المناسب تأجيل التطعيم. 2. جهّز السجل الطبي: احضر سجل التطعيمات السابق لتحديثه وضمان عدم عرض المزيد.....''';
  static const String beforeVaccination = " قبل التطعيم";
  static const String postVaccination = "بعد التطعيم";
  static const String postVaccineTips =
      '''1. راقب الآثار الجانبية: تحقق من وجود أي أعراض مثل احمرار أو تورم في مكان الحقن، حمى خفيفة، أو بكاء مستمر.
2. استخدم الكمادات الباردة: ضع كمادات باردة على موضع الحقن لتخفيف عرض المزيد....''';
  ...
  static const String commonSideEffectsDetails =
      "1. احمرار أو تورم في موضع الحقن: يحدث غالبًا ويختفي خلال يوم أو يومين. 2. ألم خفيف في موضع الحقن: قد يشعر الطفل بألم عند قراءه المزيد......";
  static const String rareSideEffects =
      "1. طفح جلدي: يظهر أحيانًا بعد التطعيمات الفيروسية الحية (مثل الحصبة). 2. تورم الغدد الليمفاوية: قد يحدث بشكل طفيف ويزول بعد قراءه المزيد......";
  ...
  static const String patientReview =
      "الدكتور محمد شخص محترف وذو خبرة كبيرة في مجاله، يتميز بأسلوبه الواضح والبسيط في الشرح. يحرص دائمًا على تقديم المساعدة للمرضى بكل اهتمام وإخلاص.";
  ...
  static const String medicationsForSideEffectsDetails =
      '''للحُمّى: باراسيتامول (تحت إشراف الطبيب).
...
للتقيؤ: تجنب الأطعمة الثقيلة مؤقتًا وتقديم السوائل تدريجيًا.
  ...
  ''';
  static const String medicationsDetails =
      "للحُمّى: باراسيتامول (تحت إشراف الطبيب). للإسهال: محاليل الجفاف الفموية (ORS). للتقيؤ: تجنب الأطعمة الثقيلة مؤقتًا وتقديم السوائل تدريجيًا.";
  ...
  static const String noNotifications =
      "ليس لديك اشعارات فى الوقت الحال تعالى لاحقا";
  static const String noArticlesAvailable =
      "لا توجد مقالات متاحة حاليًا. تحقق لاحقًا للحصول على المزيد من المحتوى";
  static const String noFavoriteArticles =
      "قائمة المقالات المفضلين فارغة. أضف مقالات هنا لتظهر لاحقًا.";
  static const String noFavoriteDoctors =
      "قائمة الطباء المفضلين فارغة. أضف اطباء هنا لتظهر لاحقًا.";
